        ...
        <div className="vcard-wrap">
          ...
          <div  className="vcard-bio">
            ...
            <ul className = "list unstyled vcard-contact">
              <li className="vcard-contact-address"><i class="fa fa-home fa-2x span v2" aria-hidden="true"></i>&nbsp; &nbsp;
                <h5 className="spanv10">San Francisco, CA, U5A</h5>
              </li>
              <li className="vcard-contact-email"><i class="fas fa-envelope fa-2x spanv2"></i>&nbsp; &nbsp;
                <h5 className="spanv10"><a href="mailto: ssankasa@mail.sfsu.edu" title="Email me">ssankasa@mail.sfsu.edu</a></h5>
              </li>
              <li className="vcard-contact-phone"><i class="fa fa-phone fa-2x span v2" aria-hidden="true"></i>&nbsp; &nbsp;
          ...
          <div className="vcard-bio social">
            ...
            <ul className="list-inline resume">
              <li className="list-inline-item">
                <span class="fa-stack fa-2x">
                  <a href="https://www.linkedin.com/in/siddharthasankasala/" target="_blank" title="Resume">
                    <i class="fas fa-circle fa-stack-2x"></i>
